...
async function handleRequest(request) {
  ...
  if (pathname === "/generate-signed-url") {
    ...
    const r2 = new S3({
      endpoint:
        "https://54d2bb9046e4bf7bf02628a8493eb8e.r2.cloudflarestorage.com",
      accessKeyId: "22143297735b69ca193f60840ce97993",
      secretAccessKey:
        "c31d6b51fb2642ee020623a5495b405dea418ed2e1c5845fb8825224bfbc2f4",
      region: "auto",
      signatureVersion: "v4",
    });
